...
# this is not a complete definition!
class Hash
  sig { params(other_hash: T::Hash[T.untyped, T.untyped], block: T.nilable(Proc)).returns(T::Hash[T.untyped, T.untyped]) }
...
module Enumerable
  ...
  sig { params(block: T.nilable(Proc)).returns(T::Boolean) }
  def many?(&block); end
