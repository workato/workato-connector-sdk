...
# source://webmock//lib/webmock/http_lib_adapters/em_http_request_adapter.rb#37
module EventMachine
  private
...
# source://webmock//lib/webmock/http_lib_adapters/em_http_request_adapter.rb#87
class EventMachine::WebMockHttpClient < ::EventMachine::HttpClient
  # source://webmock//lib/webmock/http_lib_adapters/em_http_request_adapter.rb#106
  def connection_completed; end

  # source://webmock//lib/webmock/http_lib_adapters/em_http_request_adapter.rb#155
  def get_response_cookie(name); end

  # source://webmock//lib/webmock/http_lib_adapters/em_http_request_adapter.rb#143
  def request_signature; end

  # source://webmock//lib/webmock/http_lib_adapters/em_http_request_adapter.rb#111
  def send_request(head, body); end

  # source://webmock//lib/webmock/http_lib_adapters/em_http_request_adapter.rb#94
  def setup(response, uri, error = T.unsafe(nil)); end

  # source://webmock//lib/webmock/http_lib_adapters/em_http_request_adapter.rb#147
  def stubbed_webmock_response; end

  # source://webmock//lib/webmock/http_lib_adapters/em_http_request_adapter.rb#129
  def unbind(reason = T.unsafe(nil)); end

  # source://webmock//lib/webmock/http_lib_adapters/em_http_request_adapter.rb#90
  def uri; end

  private

  # source://webmock//lib/webmock/http_lib_adapters/em_http_request_adapter.rb#185
  def build_request_signature; end

  # source://webmock//lib/webmock/http_lib_adapters/em_http_request_adapter.rb#167
  def build_webmock_response; end

  # source://webmock//lib/webmock/http_lib_adapters/em_http_request_adapter.rb#175
  def headers_and_body_processed_by_middleware; end

  # source://webmock//lib/webmock/http_lib_adapters/em_http_request_adapter.rb#208
  def make_raw_response(response); end
end

# source://webmock//lib/webmock/http_lib_adapters/em_http_request_adapter.rb#58
class EventMachine::WebMockHttpConnection < ::EventMachine::HttpConnection
  # source://webmock//lib/webmock/http_lib_adapters/em_http_request_adapter.rb#59
  def activate_connection(client); end

  # source://webmock//lib/webmock/http_lib_adapters/em_http_request_adapter.rb#82
  def drop_client; end
end
...
# source://webmock//lib/webmock/http_lib_adapters/em_http_request_adapter.rb#14
class WebMock::HttpLibAdapters::EmHttpRequestAdapter < ::WebMock::HttpLibAdapter
  class << self
    # source://webmock//lib/webmock/http_lib_adapters/em_http_request_adapter.rb#27
    def disable!; end

    # source://webmock//lib/webmock/http_lib_adapters/em_http_request_adapter.rb#20
    def enable!; end
  end
end

# source://webmock//lib/webmock/http_lib_adapters/em_http_request_adapter.rb#17
WebMock::HttpLibAdapters::EmHttpRequestAdapter::OriginalHttpClient = EventMachine::HttpClient

# source://webmock//lib/webmock/http_lib_adapters/em_http_request_adapter.rb#18
