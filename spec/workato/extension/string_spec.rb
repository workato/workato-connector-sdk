...
module Workato::Extension
  RSpec.describe String do
    ...
    describe '#rsa_sha512' do
      ...
      let(:expected_base64) do
        <<~BASE64.gsub("\n", '')
          
        BASE64
      end

      it 'signs a string correctly' do
        expect(input.rsa_sha512(pem_key).base64).to eq(expected_base64)
      end
    ...
    describe '"Hello".encode_sha512' do
      subject(:formula) { 'Hello'.encode_sha512.to_json }

      it { is_expected.to eq('0x3615f80c9d293ed7402687f94b22d58e529b8cc7916f8fac7fddf7fbd5af4cf777d3d795a7a00a16bf7e7f3fb9561ee9baae480da9fe7a18769e71886b03f315') } # rubocop:disable Layout/LineLength
    end

    describe '"Hello".encode_sha512_256' do
      subject(:formula) { 'Hello'.encode_sha512_256.to_json }

      it { is_expected.to eq('0x37653735623138623838643263623862653935623035656336313165353465323436303430386132646366383538663934353638363434366339643037616163') } # rubocop:disable Layout/LineLength
    end
