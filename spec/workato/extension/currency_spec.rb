  ...
  RSpec.describe Currency do
    describe 'country lookup' do
      ['US', 'USA', '840', 'United States', 'United States of America'].each do |cname|
        it "should lookup successfully by \"#{cname}\" using all helpers" do
      ...
      it 'should not lookup successfully by "xxxxxx" using all helpers' do
    ...
    describe 'state lookup' do
      %w[California CA caliFORNIA].each do |state_name|
        it "should lookup successfully by \"#{state_name}\" using all helpers" do
      ...
      %w[KA Karnataka KarnaTAKa].each do |state_name|
        it "should lookup successfully by \"#{state_name}\" using all helpers with country name" do
      ...
      it 'should not lookup successfully by "xxxxxx" using all helpers with country name' do
